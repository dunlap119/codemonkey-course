...
const renderers = {
  ...
  // activity, quiz, and puzzle renderers register themselves on import
};
...
export async function renderSection(sectionId, containerEl) {
  ...
  `;
  return { requireInteraction: section.type === 'activity' || section.type === 'quiz' || section.type === 'puzzle' };
}
...
/** Register additional renderers (used by activity/quiz/puzzle modules) */
