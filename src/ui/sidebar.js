...
function renderLogo() {
  ...
  container.innerHTML = `<a href="#/home" style="display:block"><img src="assets/images/codemonkey-logo.png" alt="CodeMonkey" style="width:170px;height:auto;margin-bottom:6px"><br><img src="assets/cal-logo-blue.png" alt="Create a Loop" style="width:130px;height:auto;opacity:0.8"></a>`;
}
